                     ...
                     <div class="swiper-wrapper d-flex border-animation-left">
                         <div class="row overflow-auto p-2">
                                     ...
                                     <div class="row">
                                         <div class="col-12 text-center">
                                             <div class="image-holder">
                                                 <a data-lightbox="<?= base_url('/assets/images/product/') . $detail_product[0]['image'] ?>" data-title="<?= $detail_product[0]['image'] ?>" href="<?= base_url('/assets/images/product/') . $detail_product[0]['image'] ?>" class="img-poster-popup">
                                                     <img src="<?= base_url('/assets/images/product/') . $detail_product[0]['image'] ?>" alt="product" class="img-fluid img-poster" width="450">
                                                 </a>
                                             </div>
                                         </div>
                                     </div>
                             ...
                             <div class="col-sm-6">
                                 ...
                                 <h4>Rp. <span class="harga-diskon diskon" name="quant[0]"><?= number_format($detail_product[0]['price_diskon']) ?></span></h4>
                                         ...
                                         <div class="col-12">
                                             <div class="row">
                                                 <div class="col-12">
                                                     <p>Qty</p>
                                                     <div class="quantity">
                                                         <button class="minus box-qty btn-number" aria-label="Decrease" data-type="minus" data-field="quant[0]" data-id_product="<?= $this->uri->segment(3) ?>" data-status="insert">&minus;</button>
                                                         <input type="number" name="quant[0]" class="input-box input-number qty-product" value="1" min="1" max="1000">
                                                         <button class="plus box-qty btn-number" aria-label="Increase" data-type="plus" data-field="quant[0]" data-id_product="<?= $this->uri->segment(3) ?>" data-status="insert">&plus;</button>
                                                     </div>
                                                 </div>
                                                 <div class=" col overflow-auto">
                                                     <p>Varian Color</p>
                                                     <div class="variant-selector">
                                                         <?php foreach ($varian as $v) : ?>
                                                             <div class="variant" data-image=<?= $v['image'] ?> data-value="<?= $v['id_color'] ?>"><?= $v['color'] ?></div>
                                                         <?php endforeach; ?>
                                                     </div>
                                                     <input type="hidden" id="selectedVariant" value="">
                                                 </div>
                                 ...
                                 <div class="banner-content py-4">
                                     <h5>Description</h5>
                                     <p><?= html_entity_decode($detail_product[0]['description']) ?></p>

                                 </div>

                                 <div class="banner-content py-2 mb-3">
                                     <p>Pengiriman</p>
                                     <div class="row">
                                         <div class="col">
                                 ...
                                 <button class="text-right btn btn-secondary addCart" data-id_product="<?= $this->uri->segment(3) ?>"><i class="fa-solid fa-cart-plus"></i> Add to Cart</button>
                                 <button class="text-right btn btn-primary buyNow" data-id_product="<?= $this->uri->segment(3) ?>"><i class="fa-solid fa-money-bill"></i> Buy Now</button>
