                                ...
                                <div class="image-holder">
                                    ...
                                    <div class="product-content">
                                        <h5 class="text-uppercase fs-5 mt-3">
                                            <a href="<?= base_url('home/detail/' . $s['id']) ?>"><?= $s['product_name'] ?></a>
                                        </h5>
                                        <a href="<?= base_url('home/detail/' . $s['id']) ?>" class="text-decoration-none" data-id_product="<?= $s['id'] ?>" data-after="Add to cart">
                                            <span><del>Rp. <?= number_format($s['price']) ?></del></span>
                                            <span><b>Rp. <?= number_format($s['price_diskon']) ?></b></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
