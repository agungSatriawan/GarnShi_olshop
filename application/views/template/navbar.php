        ...
        <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart" aria-labelledby="My Cart">
            ...
            <div class="offcanvas-body">
                <div class="order-md-last">
                    ...
                    <ul class="list-group mb-3 data-cart">
                        <?php $price = 0; ?>
                        <?php foreach ($cart as $c) : ?>
                            <li class="list-group-item d-flex justify-content-between lh-sm p-3 list-cart my-3">
                                <div>
                                    <img src="<?= base_url('assets/images/product/' . $c['image_varian']) ?>" alt="<?= $c['product_name'] ?>" width="50">
                                    <h6 class="my-0"><?= $c['product_name'] ?></h6>
                                    <small class="text-body-secondary"><?= $c['qty'] ?>X</small>
                                    <small class="text-body-secondary"><?= $c['color'] ?></small>
                                    <small class="text-body-secondary"><?= $c['size'] ?></small>
                                </div>
                                <span class="text-body-secondary">Rp. <?= number_format($c['price'] * $c['qty']) ?></span>
                            </li>
                            <?php $price += ($c['price'] * $c['qty']) ?>
                        <?php endforeach; ?>

                        <li class="list-group-item d-flex justify-content-between total-cart">
                            <span>Total (RP)</span>
                            <strong><?= number_format($price) ?></strong>
                        </li>
                    </ul>

                    <a href="<?= base_url('product/shipping_cart') ?>" class="w-100 btn btn-primary btn-lg" type="submit">open shopping cart</a>
                </div>
            </div>
        </div>
    <?php endif ?>
            ...
            <div class="row justify-content-between align-items-center w-100 ">
                ...
                <div class="col-6 col-lg-auto align-self-center text-end">
                    <ul class="list-unstyled d-flex m-0 d-inline-flex">
                        ...
                        <?php if ($this->session->userdata('email') != '') : ?>
                            <li class="d-none d-lg-block">
                                <a href="index.php" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">Cart <span class="cart-count">(<?= count($cart) ?>)</span>
                                </a>
                            </li>
                        <?php endif ?>
                        ...
                        <li class="d-lg-none">
                            <a href="<?= base_url('shop') ?>" class="mx-2">
                        ...
                        <?php if ($this->session->userdata('email') != '') : ?>
                            ...
                            <?php if ($this->session->userdata('role_id') == 1) : ?>
                                <li class="user-box mx-2" data-toggle="tooltip" title="Dashboard Admin">
                                    <a href="<?= base_url('admin') ?>" class="user-button">
                                        <i class="fa-solid fa-user-gear"></i>

                                    </a>
                                </li>
                            <?php endif ?>
                            <li class="user-box mx-2" data-toggle="tooltip" title="Account">
                                <a href="<?= base_url('auth/logout') ?>" class="user-button">
                                    <i class="fa-solid fa-right-from-bracket"></i>
                                </a>
                            </li>
                        <?php else : ?>
                            <li class="user-box mx-2" data-toggle="tooltip" title="Account">
                                <a href="<?= base_url('auth/login') ?>" class="user-button">
                                    <svg width="24" height="24" viewBox="0 0 24 24">
