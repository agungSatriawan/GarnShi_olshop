              ...
              <ul class="nav nav-tabs fancyTabs" role="tablist">
                  ...
                  <!-- <li class="tab fancyTab">
                      ...
                      <a id="tab1" href="#tabBody1" role="tab" aria-controls="tabBody1" aria-selected="true" data-toggle="tab" tabindex="0">
                          ...
                          <h1><i class="text-secondary fa-regular fa-rectangle-list d-block"></i></h1>
                          <span class="hidden-xs">Product Management</span>
                      </a>
                      <div class="whiteBlock"></div>
                  </li> -->
              </ul>
                                  ...
                                  <div class="card">
                                      ...
                                      <div class="row justify-content-center">
                                          <div class="col-sm-11 p-3 table-responsive">
                                              <table class="table table-bordered table-hover table-striped" id="t_list_produk_varian">
                                                  <thead>
                                                      <tr>
      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
                  ...
                  <div class="row">
                      ...
                      <div class="col">
                          <div class="mb-3">
                              ...
                              <input type="text" disabled name="product_name" class="form-control">
                                  ...
                                  <div class="input-group mb-3">
                                      <div class="input-group-prepend">
                                          <div class="input-group-text">
                                              <input type="checkbox" disabled id="<?= $c['id'] ?>" aria-label="Checkbox for following text input" name="category[]" value="<?= $c['id'] ?>">
                                          </div>
                                      </div>
                          ...
                          <div class="row">
                              <div class="col-sm-12">
                                  <div class="mb-3">
                                      ...
                                      <select class="form-control" disabled name="uom" id="">
                              ...
                              <div class="col-sm-12">
                                  <div class="mb-3">
                                      ...
                                      <textarea disabled class="form-control" name="desc" id="" rows="4"></textarea>
                  ...
                  <div class="box-variasi">
                      ...
                      <div class="row">
                          ...
                          <div class="col">
                              ...
                              <input type="text" name="priceDiskon[]" class="form-control priceDiskonUpdate">
                          </div>
                          <div class="col">
                              <label for="">Stock</label>
                              <input type="text" name="stock[]" class="form-control stockUpdate">
                          </div>
                          <div class="col">
                              <label for="">Keterangan</label>
                              <input type="text" name="keterangan[]" class="form-control keteranganUpdate">
                          </div>
                      </div>
                  </div>
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" name="submitAddProductVarian" class="btn btn-primary varian">Add Product</button>
